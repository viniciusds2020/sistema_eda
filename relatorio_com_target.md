...
**Dataset:** Análise de Risco de Crédito
**Gerado em:** 2026-01-30 17:59:52
...
![idade](relatorio_com_target_plots/numeric_idade.png)

![score_credito](relatorio_com_target_plots/numeric_score_credito.png)
...
![genero](relatorio_com_target_plots/categorical_genero.png)

![possui_cartao](relatorio_com_target_plots/categorical_possui_cartao.png)

![inadimplente](relatorio_com_target_plots/categorical_inadimplente.png)
...
![Correlação](relatorio_com_target_plots/correlation_matrix.png)
...
| --- | --- | --- | --- | --- | --- |
| 1 | genero | categorical | Cramér's V | 0.0293 | Associação não significativa |
| 2 | idade | numeric | Eta-squared | 0.0077 | Diferença pequena entre classes |
| 3 | score_credito | numeric | Eta-squared | 0.0057 | Diferença pequena entre classes |
| 4 | possui_cartao | categorical | Cramér's V | 0.0055 | Associação não significativa |
...
| --- | --- | --- | --- | --- |
| 1 | genero | categorical | 0.0005 | 1.0000 |
| 2 | idade | numeric | - | 0.5000 |
| 3 | score_credito | numeric | 0.0220 | 0.5000 |
| 4 | possui_cartao | categorical | 0.0000 | 0.0000 |
...
*Relatório gerado automaticamente pelo SmartEDA Python em 2026-01-30 17:59:55*
